...
const modalDesc = document.getElementById('modal-desc'); // NOVO: Elemento da descrição
...
// === NOVA LÓGICA: AGENDAR REPARO (Enviando dados para a próxima página) ===
// Seleciona todos os botões "Agendar Reparo" (que usam a classe btn-primary nos cards)
...
// Lógica bônus para o botão "Marcar todas como lidas"
